...
const locales = {
  'en-US': {
    ...
    // About page
    INFO: 'INFO',
    TERMS: 'Terms used in the map',
    HOW_TO_READ: 'Reading the report',
    HOW_GATHERED: 'Presentation of information',
    READ_MORE: 'Read more',
    SAFER_GLOBE: 'SaferGlobe',
    ...
    // About page
    INFO: 'INFO',
    TERMS: 'Kartassa käytetyt termit',
    HOW_TO_READ: 'Kuinka lukea raporttia',
    HOW_GATHERED: 'Miten tiedot on esitetty',
    READ_MORE: 'Lue lisää',
    SAFER_GLOBE: 'SaferGlobe',
